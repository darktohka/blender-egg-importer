...
## Note
The plugin was initially created to support Blender 2.7x but has been upgraded to support later versions, including later versions 3.2+, 4.x and 5.x.
Blender versions < 3.2x are no longer supported.
...
**To be used with the darktohka [MAYBEE](https://github.com/darktohka/MAYBEE) fork!**
